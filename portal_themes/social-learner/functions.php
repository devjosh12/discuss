...
function boss_child_enqueue_styles() {
    ...
    wp_enqueue_style( 'child-style', get_stylesheet_directory_uri() . '/css/main.css', false, '1.0.3', 'all' );
}
...
.module .module-lessons ul li.current a, 
            ...
            .page-template-page-no-buddypanel .header-inner .left-col .header-navigation ul li.hideshow li a {
                color: ". esc_attr( get_option( 'boss_layout_titlebar_color' ) ) .";
            }
            .page-template-page-no-buddypanel .header-inner .left-col .header-navigation ul li.hideshow li a:hover,
