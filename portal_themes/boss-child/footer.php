                ...
                <div class="footer-inner-bottom">
                    <div class="footer-inner">
                        <p class="footer-credits <?php if ( !has_nav_menu( 'secondary-menu' ) ) : ?>footer-credits-single<?php endif; ?>">
                            <?php _e( "&copy;", 'boss' ); ?> <?php echo date('Y'); ?> <?php bloginfo('name'); ?> <?php _e( "<span class='buddyboss-credit'>&middot; Powered by <a href='http://discuss.forumias.com' title='Stellar Digital' target='_blank'>more than 1,50,000 ForumIAS Lovers</a></span>", 'boss' ); ?> 
                        </p>
