...
CHANGED FILES:
	...
	archive.php
	author.php
	/bpdocs_gds/docs-header.php (added)
	/bpdocs_gds/single/comments.php (added)
	/bpdocs_gds/single/index.php (added)
	/bpge/front/extras_fields_add_edit.php (added)
	/bpge/front/extras_fields_list.php (added)
	/bpge/front/extras_general.php (added)
	/bpge/front/extras_pages_add_edit.php (added)
	/bpge/front/extras_pages_list.php (added)
	/bpge/readme.txt (added)
	/buddyboss-inbox/members/single/messages/compose.php (added)
	/buddyboss-inbox/members/single/messages/cmessages-loop.php (added)
	...
	/buddypress/groups/single/invite-anyone.php (added)
	/buddypress/members/single/member-header.php
	buddypress-groups-single.php
	buddypress-sitewide.php
	category.php
	/css/jquery.growl.css
	/css/main-desktop.css
	/css/main-global.css
	/css/main-mobile.css
	/docs/docs-header.php (added)
	/docs/docs-loop-old.php (added)
	/docs/home-wiki.php (added)
	/docs/single/edit-inner.php (added)
	/docs/single/edit.php (added)
	/docs/single/groupnav.php (added)
	/docs/single/history-inner.php (added)
	/docs/single/history.php (added)
	/docs/single/index-inner.php (added)
	/docs/single/index.php (added)
	header.php
	/js/buddyboss.js
	/js/jquery.growl.js
	...
	style.css
	/tree/index-compat.php (added)
	/tree/tree-loop.php (added)

TESTED WITH:

	-- WordPress --
	WordPress 4.1, 4.2, 4.3+
...
CHANGED FILES:
	...
	/buddyboss-inc/buddyboss-widgets/buddyboss-widget-loader.php
	/buddyboss-inc/theme-functions.php
	/css/main-global.css
	/css/main-mobile.css
	header.php
