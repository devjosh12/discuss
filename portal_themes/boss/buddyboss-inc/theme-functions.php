...
function buddyboss_scripts_styles()
{
    ...
    */
	...
	if ( !is_admin() ) {
		...
		wp_enqueue_style( 'boss-main-global', get_template_directory_uri().'/css/main-global.css', array( 'fontawesome'), '1.2.1', 'all' );
        ...
        if(isset($_COOKIE['switch_mode']) && (get_option( 'boss_layout_switcher' ) != 'no')){
            if($_COOKIE['switch_mode'] == 'mobile') {
                wp_enqueue_style( 'boss-main-mobile', get_template_directory_uri().'/css/main-mobile.css', array( 'fontawesome'), '1.2.1', 'all' );
                $only_mobile = true;              
            } else {
                wp_enqueue_style( 'boss-main-desktop', get_template_directory_uri().'/css/main-desktop.css', array( 'fontawesome'), '1.2.1', 'screen and (min-width: 481px)' );
                wp_enqueue_style( 'boss-main-mobile', get_template_directory_uri().'/css/main-mobile.css', array( 'fontawesome'), '1.2.1', 'screen and (max-width: 480px)' );
            }
        // Defaults   
        } else {
            if(is_phone()) {
                ...
                if(get_option('boss_layout_tablet') == 'desktop') {
                     wp_enqueue_style( 'boss-main-desktop', get_template_directory_uri().'/css/main-desktop.css', array( 'fontawesome'), '1.2.1', 'all' );
                }  else {
                    wp_enqueue_style( 'boss-main-mobile', get_template_directory_uri().'/css/main-mobile.css', array( 'fontawesome'), '1.2.1', 'all' );
                    $only_mobile = true; 
                } 
	 ...
	 */
	if ( !is_admin() ) {
		wp_register_script( 'buddyboss-main', get_template_directory_uri().'/js/buddyboss.js', array( 'jquery' ), '1.2.1' );
...
//add_action( 'wp_footer', 'print_emi_debug' );
function print_emi_debug(){
    echo '<pre>';
    //var_dump( buddypress()->bp_options_nav );
    var_dump( get_option( 'bboss_bpd_sg_group_navs_info' ) );
    echo '</pre>';
}
