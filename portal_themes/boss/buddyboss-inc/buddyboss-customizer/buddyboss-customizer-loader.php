...
function buddyboss_customize_register( $wp_customize ) {
    ...
    */
	...
	$wp_customize->add_section( 'boss_layout_section' , array(
        ...
        // Inputs compatibiltiy mode
        $wp_customize->add_setting( 'boss_inputs', array(
                'default'   		=> 'false',
                'capability'        => 'edit_theme_options',
                'type'           	=> 'option',
            ) );
        $wp_customize->add_control( 'boss_inputs', array(
            'label'  	    	=> __( 'Inputs compatibility mode', 'boss' ),
            'section'    		=> 'boss_layout_section',
            'settings'  	 	=> 'boss_inputs',
            'type'              => 'radio',
      ...
      /* Header height based on logo height */
       ...
       .btn-group.inverse > .btn:first-child:not(:last-child) {
        ...
        .site #buddypress .plus-or-minus {
            background: <?php echo esc_attr( get_option( 'boss_links_color' ) ); ?>;
        }
        .author-cell,
        .title-cell > a {
            color: <?php echo esc_attr( get_option( 'boss_links_pr_color' ) ); ?>;
        ...
        .currently-viewing a[title="View All Docs"] {
            background: <?php echo esc_attr( get_option( 'boss_links_color' ) ); ?> none repeat scroll 0 0;
        }
