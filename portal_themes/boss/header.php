...
<body <?php if ( current_user_can('manage_options') ) : ?>id="role-admin"<?php endif; ?> <?php body_class(); ?> data-logo="<?php if ( get_theme_mod( 'buddyboss_logo' ) ){ echo'1'; }else{ echo '0'; } ?>" data-inputs="<?php echo get_option( 'boss_inputs', 'false' ); ?>">
    ...
    <div id="left-panel" class="menu-panel">
        <div id="left-panel-inner">
            <div id="scroll-area">
				...
				<?php
				if(!is_page_template( 'page-no-buddypanel.php' ) && !(get_option( 'buddyboss_panel_hide' ) == '0' && !is_user_logged_in())) {
