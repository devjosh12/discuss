...
function buddyboss_scripts_styles()
{
	...
	if ( !is_admin() ) {
		...
		wp_enqueue_script( 'buddyboss-mobile-main', get_template_directory_uri() . '/js/mobile-main.js', array('jquery'), '3.1', true );
	}
	...
	if ( !is_admin() )
		wp_enqueue_style( 'buddyboss-wp-frontend', get_template_directory_uri().'/css/wordpress.css', false, '3.1.2', 'all' );
