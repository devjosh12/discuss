...
<?php if (bp_is_group() || bp_is_my_profile() || bp_is_user() || bp_is_user_activity() || 'activity' == bp_dtheme_page_on_front()
		...
		<?php if ( is_user_logged_in() ) : ?>
			...
			<?php do_action( 'bp_before_activity_post_form' ); ?>
				...
				<p class="activity-greeting">
					...
					<?php elseif ( bp_is_current_component( 'activity' ) || bp_is_my_profile() && bp_is_user_activity() ): ?>
