		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<!--		<li>
						...
						<li class="divider-vertical"></li>
						<li>
							<a href="{link path="/entry/signin"}" class="SignInPopup">Login with  Google/FB Account							<i class="icon-signin"></i> <b>Sign in</b>
							</a>
						</li>
						{/if}
					</ul>
    ...
    <!-- Code ends @neyawn -->
		...
		<div class="row-fluid">
			...
			<!-- END -->
				...
				<div class="Box fb-like-box span4" data-href="https://www.facebook.com/pages/ForumIAS/439916229375001?sk=app_190322544333196" data-width="292" data-show-faces="true" data-stream="true" data-header="true"></div>
			</div>
		</div>
